...
async def send_verification_email(email: EmailStr, host: URL, first_name: str):
    """
    ...
    try:
        ...
        email_body = template.render(host=host, token=verification_token, first_name=first_name)
